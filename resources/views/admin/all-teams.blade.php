...
@section('title')
    Team | {{ Auth::user()->name }} | Admin Panel | {{ config('app.name') }}
@endsection
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 mb-20">
                                ...
                                <input type="text" name="profession" class="form-control input-form-dark radius-8"
                                    placeholder="Enter Profession" value="{{ old('profession') }}" required>
                            </div>
                            <div class="col-12 mb-20">
                            ...
                            <div class="col-12 mb-20">
                                ...
                                <input type="url" name="github" class="form-control input-form-dark radius-8"
                                    placeholder="Enter github" value="{{ old('github') }}">
                            </div>
                            <div class="col-12 mb-20">
                                ...
                                <input type="url" name="discord" class="form-control input-form-dark radius-8"
                                    placeholder="Enter discord" value="{{ old('discord') }}">
                            </div>
                            <div class="col-12 mb-20">
