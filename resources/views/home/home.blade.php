...
.particle.particle-1 { top: 15%; left: 10%; animation-delay: 0s; }
.particle.particle-2 { top: 30%; left: 80%; animation-delay: 1s; }
.particle.particle-3 { top: 50%; left: 20%; animation-delay: 2s; }
.particle.particle-4 { top: 70%; left: 70%; animation-delay: 0.5s; }
.particle.particle-5 { top: 25%; left: 60%; animation-delay: 1.5s; }
.particle.particle-6 { top: 80%; left: 30%; animation-delay: 2.5s; }
.particle.particle-7 { top: 40%; left: 90%; animation-delay: 0.3s; }
.particle.particle-8 { top: 85%; left: 85%; animation-delay: 1.8s; }
